...
INTL_MENU = [
    ...
    {"type": "separator"},
    {"type": "header", "label": "Europa Club Masc"},
    {"type": "link", "slug": "europe/champions",        "label": "Champions League Masc"},
    {"type": "link", "slug": "europe/european-league",  "label": "European League Masc"},
    {"type": "link", "slug": "europe/cup-men",           "label": "European Cup Masc"},
    {"type": "header", "label": "Europa Club Fem"},
    {"type": "link", "slug": "europe/champions-women",       "label": "Champions League Fem"},
    {"type": "link", "slug": "europe/european-league-women","label": "European League Fem"},
    {"type": "link", "slug": "europe/cup-women",             "label": "European Cup Fem"},
    {"type": "header", "label": "Europa Selecciones"},
    {"type": "link", "slug": "europe/euro-men",   "label": "EHF EURO Masc"},
    {"type": "link", "slug": "europe/euro-women", "label": "EHF EURO Fem"},
    {"type": "link", "slug": "europe/other",      "label": "Otras EHF"},
    {"type": "separator"},
    {"type": "header", "label": "Europa Países"},
